...
export const config: WebdriverIOConfig = {
    ...
    //
    specs: [
         `${process.cwd()}/src/test/com.demoblaze.qa/features/**/*.feature`
    ],
    // Patterns to exclude.
    exclude: [
    ...
    services: ['firefox-profile', ['performancetotal',
        // The options (with default values)
          {
              disableAppendToExistingFile: false,
              performanceResultsFileName: "REPORTE-PERFORMANCE",
    ...
    cucumberOpts: {
        ...
        import: [
            'src/test/com.demoblaze.qa/step-definitions/*.ts',
            'src/test/com.demoblaze.qa/support/*.ts',
        ],
